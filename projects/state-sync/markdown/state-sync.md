...
|  [StateSyncModule](./state-sync.statesyncmodule.md) |  |
...
|  [SyncHttpFetcher](./state-sync.synchttpfetcher.md) | Injected by consumer application with token [SYNC\_HTTP\_FETCHER](./state-sync.sync_http_fetcher.md)<!-- -->. |
...
|  [SyncStateConfig](./state-sync.syncstateconfig.md) | Configuration for synchronized state management. Injected by consumer application with token [SYNC\_STATE\_CONFIG](./state-sync.sync_state_config.md) |

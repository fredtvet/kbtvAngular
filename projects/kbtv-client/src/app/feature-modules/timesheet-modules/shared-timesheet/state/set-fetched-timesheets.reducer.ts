...
import { StateFetchedModels, _getRangeWithRelations } from 'state-model';
...
type State = Immutable<StateTimesheets & StateMissions & StateFetchedModels<StateTimesheets>>;
...
export const SetFetchedTimesheetsReducer = _createReducer(
    ...
    (state: State, action: Immutable<SetFetchedTimesheetsAction>) => {
        ...
        return {
            timesheets,
            fetchedModels: {...state.fetchedModels, timesheets: true}
        };
    }
)  

...
import { WeekListFilterSheetWrapperComponent } from 'src/app/shared-timesheet/components/week-list-filter/week-list-filter-sheet-wrapper.component';
...
export class TimesheetAdminListComponent extends SubscriptionComponent{
  ...
  updateUri = (year?: number, userName?: string): void => {
    if(!year && !userName) this.router.navigate(['timer/administrering']);
    else this.router.navigate(['timer/administrering', userName || this.selectedUserName, year || this.selectedYear])
  }

...
export class TimesheetWeekListComponent implements OnInit {
  ...
  goToWeekView = (year: number, weekNr: number) => {
    this.router.navigate(['/mine-timer/ukevisning'], { queryParams: {year, weekNr}} )
  }
  ...
  private updateYear = (year: number) => this.router.navigate(['mine-timer/ukeliste'], { queryParams: {year}})

...
// export interface OnGetWithRelations { 
//     getWithRelations$: <T>(
//         stateSlice$: (properties: (keyof Object)[]) => Observable<Object>,     
//         cfg: GetWithRelationsConfig,
//         id: any, 
//     ) =>  Observable<T> 
// }
// export interface OnGetByWithRelations { 
//     getByWithRelations$: <T>(
//         stateSlice$: (properties: (keyof Object)[]) => Observable<Object>,
//         cfg: GetWithRelationsConfig, 
//         filter?: (value: T, index?: number, Array?: any[]) => boolean
//     ) => Observable<T[]>
// }